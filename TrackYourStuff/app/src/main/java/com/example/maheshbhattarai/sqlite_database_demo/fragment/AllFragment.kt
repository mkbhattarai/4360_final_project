...
class AllFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): AllFragment {
    ...
    fun  initComponent(view : View){
        ...
        allRecyclerView.layoutManager = LinearLayoutManager(mContext, LinearLayout.VERTICAL, false) as RecyclerView.LayoutManager?
        if (db!=null) {
            if (db.getAllJob(Apprefence.getJobCat(mContext)) != null) {
